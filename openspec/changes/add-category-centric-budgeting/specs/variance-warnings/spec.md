...
## Summary
Strict budget discipline with 1% warning and 10% critical thresholds for category overspending.
...
- Depends on: category-budgets-data (reads planned_amount)
- Depends on: category-budget-api (transactions for actual_amount)
- Related to: lazy-consolidation (variance calculated during consolidation)
