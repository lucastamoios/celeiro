...
## Summary
Enforce strict zero-based budgeting by ensuring 99.75% of income is allocated to categories.
...
- Depends on: add-category-centric-budgeting (needs category budgets)
- Related to: variance-warnings (similar threshold logic)
